...
**CV death's share of primary-composite events — CORRECTED per director Wave-2-closure challenge NT-001:** an earlier version of this memo computed CV death's share as (123+169)/(331+410) = 39.4% and treated this as a competing "exact" figure against the source's "approximately 35%." **That computation was methodologically invalid and is retracted.** FLOW's primary outcome is a time-to-*first*-event composite, but Table 2's "components of primary outcome" rows are *not* a mutually exclusive first-event partition — summing all five component counts for the semaglutide arm (165+92+87+5+123 = 472) already exceeds the 331 actual first-event primary-outcome count, confirming that a single participant can be tallied in more than one component row (e.g., a participant with an earlier ≥50% eGFR decline who later also dies of a cardiovascular cause) while contributing only one event to the 331/410 first-event totals. Dividing an overlapping-component numerator by the mutually-exclusive first-event denominator (741) therefore does not yield a valid "share of primary-composite events," and no exact first-event-attributable CV-death share is derivable from the published aggregate counts. **The only defensible statement is the source's own calibrated language:** CV death accounts for **"approximately 35% of the components of the primary endpoint"** [`FLOW-SUPPLEMENT-2024`, line 755, Table S2 "Other considerations" row] — an approximate, component-level descriptive statement, not a precise first-event partition. **This is also never a claim about ~35% of the treatment effect: event-share and effect-share are different quantities**, and no computation in this memo should be read as apportioning 35% (or 39.4%, or any other percentage) of the observed HR/risk reduction to the CV-death component specifically. Discrepancy #1 in §11 is updated accordingly (no longer a live numeric conflict — see below).
...
**Verification-tier disclosure, added per director Wave-2-closure challenge NT-002:** per CLAUDE.md rule 9, this entire table is **contextual only, not rankable, and not independently confirmed against each trial's own primary publication** — none of the five comparator rows below were checked by me against primary full text (NEJM/Eur Heart J HTML or PDF); they came only from WebSearch snippets quoting those journals (see the verification-tier note at the end of this section). **Treat every HR/CI/N in the comparator rows as NR (not independently primary-verified, not to be used for ranking or as a load-bearing headline number) until a lane or the director re-checks it directly against the primary article** — only the **FLOW** row in this table carries this lane's normal (primary-source, PDF-page-verified) confidence level.
...
| Trial | Verification tier | Drug (dose) | N | Diabetes required? | Approx. eGFR floor/design | Primary composite (brief) | Primary HR (95% CI) | Median follow-up |
|---|---|---|---:|---|---|---|---:|---:|
| **FLOW** (`FLOW-PRIMARY-2024`) | **Primary-verified** (this lane, PDF page 8) | Semaglutide 1.0 mg SC weekly | 3533 | Yes (T2D) | eGFR 25–75 (two pathways; ≥60 capped at 20% of N) | Kidney failure / ≥50% eGFR decline / kidney death / **CV death** | 0.76 (0.66–0.88) | 3.4 y (stopped early) |
| **CREDENCE** (canagliflozin, NEJM 2019, doi 10.1056/NEJMoa1811744, PMID 30990260) | **NR — secondary/WebSearch only, not primary-verified** | Canagliflozin 100 mg | 4401 | Yes (T2D) | eGFR ≥30–<90 (lower floor ~30, higher than FLOW/DAPA-CKD) | ESKD / doubling of serum creatinine / renal or CV death | 0.70 (0.59–0.82) | 2.6 y (stopped early) |
| **DAPA-CKD** (dapagliflozin, NEJM 2020, doi 10.1056/NEJMoa2024816, PMID 32970396) | **NR — secondary/WebSearch only, not primary-verified** | Dapagliflozin 10 mg | 4304 (2152/2152) | No — CKD with or without T2D | eGFR 25–75, UACR ≥200 mg/g (lower UACR floor than CREDENCE) | Sustained ≥50% eGFR decline / ESKD / renal or CV death | 0.61 (0.51–0.72) | 2.4 y (stopped early) |
| **EMPA-KIDNEY** (empagliflozin, NEJM 2023, doi 10.1056/NEJMoa2204233, PMID 36331190) | **NR — secondary/WebSearch only, not primary-verified** | Empagliflozin 10 mg | 6609 (3304/3305) | No — >50% without diabetes; broadest eGFR range (down to ~20, and normoalbuminuric patients allowed at higher eGFR) | eGFR ≥20; UACR unrestricted at lower eGFR strata | Kidney disease progression or CV death | 0.72 (0.64–0.82) | ~2 y (stopped early) |
| **FIDELIO-DKD** (finerenone, NEJM 2020, doi per PubMed 33264825) | **NR — secondary/WebSearch only, not primary-verified** | Finerenone (nonsteroidal MRA) | 5674 (2833/2841) | Yes (T2D) | eGFR 25–<75, albuminuric DKD | Kidney failure / sustained ≥40% eGFR decline / renal death | 0.82 (0.73–0.93) | 2.6 y |
| **FIDELITY pooled** (FIDELIO-DKD + FIGARO-DKD, Eur Heart J 2022) | **NR — secondary/WebSearch only, not primary-verified** | Finerenone | 13,026 | Yes (T2D) | Broader combined eGFR/UACR range across the two component trials | CV composite; separately, kidney composite | CV: 0.86 (0.78–0.95); kidney composite: 0.77 (0.67–0.88) | 3.0 y |
...
**Three distinct discontinuation figures exist in this evidence set and must not be conflated — disambiguated per director Wave-2-closure challenge TN-001:**

1. **AE-driven permanent discontinuation (of trial product):** 233/1767 (13.2%) semaglutide vs 211/1766 (11.9%) placebo [`FLOW-PRIMARY-2024`, Table 3, and prose: *"Adverse events leading to permanent discontinuation of semaglutide or placebo were more common in the semaglutide group than in the placebo group (233 [13.2%] vs. 211 [11.9%])"* — `fulltext/FLOW_primary_NEJM_2024_fulltext.md` lines 582–586].
2. **GI-specific discontinuation (the subset of #1 attributed to GI disorders):** 79/1767 (4.5%) semaglutide vs 20/1766 (1.1%) placebo — continuation of the same sentence: *"...this finding was driven mainly by discontinuation because of gastrointestinal disorders (79 [4.5%] vs. 20 [1.1%])"* [`FLOW-PRIMARY-2024`, `fulltext/FLOW_primary_NEJM_2024_fulltext.md` line 991 — the sentence is split across lines 582–586 and 991 by a column-interleaving artifact in the local text extraction, but is one continuous sentence in the original].
3. **Overall (any-reason) permanent discontinuation — two non-identical figures, neither broken out by arm:**
   - **26%**, `FLOW-PRIMARY-2024`: *"vital status was able to be confirmed at the end of trial for 3482 participants (98.6%). Semaglutide or placebo was permanently discontinued by 26% of participants during the trial, with adherence to the trial regimen averaging 89% of the planned time during the trial period."* [`fulltext/FLOW_primary_NEJM_2024_fulltext.md`, sentence spans line 303 → line 468–470 due to the same column-interleaving artifact]. This is a **pooled-both-arms** statement — no per-arm split is given anywhere in the primary paper for this specific figure.
   - **28.8%**, `FLOW-SGLT2-2024` (Mann et al. 2024): *"Adherence to the trial treatment regimen was reported for 89% of the planned time during the study period... permanent discontinuation of randomized treatment was reported in 28.8% and vital status was known in 98.6%."* [`fulltext/glp1_cardiorenal_Mann_2024.md`, lines 104–107]. This is also a **pooled-both-arms**, whole-trial statement (it appears in the same "Participant characteristics" paragraph as the SGLT2i-baseline-stratified numbers, but this specific 28.8%/89%/98.6% trio is presented as trial-wide, not stratified by SGLT2i subgroup).

   **Investigation of whether #3's two figures (26% vs 28.8%) reflect different populations/analysis windows:** they do **not** appear to. Both papers report, in the same breath as their respective discontinuation figure, the **identical companion statistics** — 89% adherence and 98.6% vital-status confirmation — strongly suggesting both are describing the same underlying whole-trial, full-analysis-set population at the same (final) database lock, not a different subgroup, arm, or interim cut. I therefore cannot attribute the 26%-vs-28.8% gap to a different population or analysis window based on the text available. The most plausible remaining explanations — which I cannot confirm from local sources — are (a) a definitional difference between "discontinuation of trial product" (primary paper's wording) and "discontinuation of randomized treatment" (Mann et al.'s wording), which could in principle count differently (e.g., one including participants who were off-treatment for a prolonged but not formally "permanent" period, per the supplement's "retrieved dropout" sensitivity-analysis definitions of "permanently discontinued treatment but remained in-trial" vs. "off treatment >5 weeks at least once" [`FLOW-SUPPLEMENT-2024`, lines 820–823] — these are two genuinely different discontinuation constructs the trialists themselves use elsewhere, though neither paper's prose explicitly maps its headline percentage to one of these two SAP-level definitions); or (b) a simple inter-paper reporting inconsistency between two companion publications drawing on the same locked database. **Resolving this definitively would require the FLOW SAP or clinical study report's exact discontinuation definitions, which are not in local `fulltext/`.** Not decision-critical (neither figure feeds into any efficacy HR/CI), but should not be silently harmonized by picking one number without stating this ambiguity.
...
|---|---|---|---|---|---|
| 1 | ~~CV death's share of primary-composite events~~ **RETRACTED, not a discrepancy** — see §4 correction (director challenge NT-001) | ~~39.4% (computed: (123+169)/(331+410) from Table 2 component counts)~~ — **withdrawn: invalid computation, components overlap and are not a first-event partition (sum of components 472 > 331 first events)** | "approximately 35%" (the only defensible figure) | `FLOW-PRIMARY-2024` Table 2 (`FLOW.pdf` p.8) vs `FLOW-SUPPLEMENT-2024` line 755 (Table S2) | **Closed as a methodological error, not a source discrepancy.** Use only the source's own "approximately 35% of the components of the primary endpoint" language; do not present any recomputed exact percentage; event-share ≠ effect-share. |
| 2 | Overall (any-reason) permanent treatment discontinuation | **26%** of participants ("Semaglutide or placebo was permanently discontinued by 26% of participants during the trial") | **28.8%** ("permanent discontinuation of randomized treatment was reported in 28.8%") | `FLOW-PRIMARY-2024`, line ~303 (continues at line 468–470) vs `FLOW-SGLT2-2024` (Mann et al. 2024), lines 104–107 | **Still unresolved as of director challenge TN-001.** Both papers report identical companion stats (89% adherence, 98.6% vital status), arguing against a different population/analysis-window explanation; more likely a definitional difference ("trial product" vs. "randomized treatment," or the SAP's distinct "permanent discontinuation" vs. "≥5-week-off-treatment first discontinuation" constructs [`FLOW-SUPPLEMENT-2024` lines 820–823]) or an inter-paper inconsistency — not resolvable from local sources; would need the SAP/CSR. See §10 for full disambiguation from the (non-conflicting) AE-specific 233/211 and GI-specific 79/20 figures. |
...
**Unresolved conflicts requiring director attention:** discrepancy #2 in §11 (overall discontinuation 26% vs 28.8%, now disambiguated from the non-conflicting AE-specific/GI-specific figures in §10) — should not be silently harmonized in `14_MASTER_EVIDENCE_TABLE.md` without picking one value and stating why, or presenting both with the ambiguity noted. Discrepancy #1 (CV-death share) is **closed/retracted**, not open — see the Wave-2-closure corrections note immediately below.

**Wave-2-closure corrections (applied in response to director challenges TN-001, NT-001, NT-002, NT-003 after `flow-nephrologist` went offline):**
- **NT-001 (retracted):** withdrew the computed "39.4%" CV-death-share figure and all arithmetic built on it (§4, former Discrepancy #1). The Table 2 components are not a mutually-exclusive first-event partition (component counts sum to more than the 331/410 first-event totals), so no exact share is derivable from the aggregate counts; only the source's own "approximately 35%" language should be used going forward, and event-share must not be conflated with effect-share.
- **TN-001 (disambiguated):** §10 now separates and locator-cites all three discontinuation figures (AE-driven 233/211; GI-specific 79/20; overall any-reason 26% vs 28.8%) and documents the investigation into whether the 26%/28.8% gap reflects different populations/windows (it does not appear to — both papers cite identical 89%/98.6% companion statistics — so a definitional or inter-paper-inconsistency explanation is more likely, but unconfirmed).
- **NT-002 (verification tier added):** §9's comparator table now carries an explicit per-row verification-tier label; all five non-FLOW rows are marked NR (secondary/WebSearch-sourced, not independently checked against primary full text) rather than presented at the same confidence tier as the FLOW row.
- **NT-003 (scope-clarified):** §7's early-stopping paragraph now explicitly disclaims any component-specific (kidney-vs-CV maturity) claim, since no such claim was intended or source-supported; flagged that `flow-nephrologist` would be the natural owner of any component-maturity question but is no longer live.
...
**Update (director relay, post-completion):** `flow-methodologist` retrieved the abstract (PMID 42567173, via paper-search MCP + CrossRef, no Sci-Hub): pooled N=30,787; primary kidney composite 973 vs 1,134 events, HR 0.84 (0.77–0.91); kidney-specific (excl. CV death) composite 347 vs 416 events, HR 0.80 (0.69–0.92). This lane did **not** independently retrieve or verify the full text/tables (declined as optional/out-of-scope, consistent with this lane's brief being FLOW-specific) — the abstract-level numbers above are relayed for Wave 3 traceability only and should be treated as methodologist-owned, not independently confirmed by the trialist lane. If a headline claim in the final synthesis leans on this pooled HR, whoever finalizes `14_MASTER_EVIDENCE_TABLE.md`/`15_CLAIM_EVIDENCE_MAP.md` should still get one independent full-text check (abstract-only sourcing is provisional per CLAUDE.md's citation-style rule).
